    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-linear-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950">
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen p-4">
        <motion.div
          ...
          className="w-full max-w-md bg-white dark:bg- rounded-2xl shadow-xl overflow-hidden backdrop-filter backdrop-blur-lg bg-opacity-95 dark:bg-opacity-90"
        >
              ...
              <div className="space-y-6">
                <motion.div variants={itemVariants}>
                  <div className={`relative border dark:border-gray-700 rounded-lg duration-300 ${loginFocused || form.login ? "border-black dark:border-white" : "border-gray-300"}`}>
                    <label className={`absolute duration-300 ${loginFocused || form.login ? "text-xs -translate-y-2.5 translate-x-2 bg-white dark:bg-gray-900 px-1" : "text-sm translate-y-3 translate-x-10 text-gray-500"}`}>
                      Login
                    </label>
